#!/usr/bin/env python3
"""
生成 5 个英文口播带字幕的智能戒指视频任务（使用实际存在的图片）
"""
import json
import os
...
scenarios = [
    ...
    },
    {
        ...
        "reference_files": [
            "keyframes/ring-01_part_09.jpg",  # 银色运动场景
            "keyframes/ring-01_part_06.jpg",  # 手机+戒指使用场景
            "keyframes/ring-01_part_25.jpg"   # 模特多角度展示
        ],
        "prompt": """(@ring-01_part_09.jpg) shows person in sportswear with JELLY BELLES smart ring silver on finger during exercise. (@ring-01_part_06.jpg) displays person using phone with smart ring visible. (@ring-01_part_25.jpg) shows model wearing smart ring at outdoor activity. Fitness athlete companion video. Scene 1 [0-3s]: Person running outdoors with ring on finger phone tracking activity in background. Text overlay: Workout Tracking Made Easy. Scene 2 [3-7s]: Phone screen displays multiple exercise modes with icons: Run Cycle Hike Golf. Person doing different exercises with ring tracking. Text overlay: 12+ Exercise Modes Run Cycle Hike Golf. Scene 3 [7-10s]: Person finishing workout checking statistics on phone. Ring sparkling on finger. Text overlays: Precise Data Every Step The Athlete's Choice. CRITICAL: Include ENGLISH VOICEOVER throughout: Take your fitness to the next level with JELLY BELLES Smart Ring. It tracks 12+ exercise modes including running cycling hiking and golf. Monitor your heart rate steps calories and distance with precision. Know your progress every step of way. The athlete's choice for accurate convenient fitness tracking. Include ENGLISH SUBTITLES matching all text overlays. Dynamic energetic style 9:16 10 seconds."""
    },
    {
        "id": "V3_GESTURE",
        ...
        "reference_files": [
            "keyframes/ring-01_part_06.jpg",  # 手机+戒指使用场景
            "keyframes/ring-01_part_25.jpg",  # 模特多角度展示
            "keyframes/ring-01_part_01.jpg"   # 手部佩戴展示
        ],
        "prompt": """(@ring-01_part_06.jpg) displays person using phone with JELLY BELLES smart ring showing gesture control. (@ring-01_part_25.jpg) shows model wearing smart ring with phone in hand. (@ring-01_part_01.jpg) shows hand with smart ring on finger. Smart gesture control video. Scene 1 [0-3s]: Person scrolling TikTok with ring phone screen changes content smoothly. Text overlay: Gesture Control Without Touching. Scene 2 [3-7s]: Close-up of double tap gesture videos switch on phone. Person swipes through content with hand gesture. Text overlay: Double Tap to Switch Content Gesture Brush. Scene 3 [7-10s]: Person using ring to take selfie remotely phone captures photo. Ring highlighted on finger. Text overlays: Remote Selfie Gesture Swing Control Everything. CRITICAL: Include ENGLISH VOICEOVER throughout: Control your phone without ever touching it. Simply double-tap your JELLY BELLES Smart Ring to switch between TikTok videos. Swipe through content with your hand. Even take remote selfies without reaching for your phone. Your smart assistant fits right on your finger making everything more convenient and effortless. Include ENGLISH SUBTITLES matching all text overlays. Tech-focused modern style 9:16 10 seconds."""
    },
    {
        "id": "V4_HEALTH",
